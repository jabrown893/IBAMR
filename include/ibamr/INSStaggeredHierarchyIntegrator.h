...
private:
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::NodeVariable<NDIM, double> > d_F_nc_var;
     ...
     */
    int d_U_nc_idx = IBTK::invalid_index, d_P_nc_idx = IBTK::invalid_index, d_F_nc_idx = IBTK::invalid_index, d_Omega_idx = IBTK::invalid_index,
